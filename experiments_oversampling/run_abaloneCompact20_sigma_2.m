...
export_fig('./plots/decay_abaloneCompact20_sigma_2_q_15.pdf');
close all;
...
export_fig(gcf,'./plots/p_plots_abaloneCompact20_sigma_2_deterministic_q_15.pdf');
close all;

p_values_plot_subspace_expected;
export_fig(gcf,'./plots/p_plots_abaloneCompact20_sigma_2_subspace_expected_q_15.pdf');
close all;