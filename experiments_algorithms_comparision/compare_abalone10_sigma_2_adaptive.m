...
save('./output/compare_abalone10_sigma_2_adaptive');

c_values_plot;
saveas(gcf,'./plots/c_plots_abalone_10_sigma_2_adaptive','fig');
export_fig(gcf,'./plots/c_plots_abalone_10_sigma_2_adaptive.pdf');
close all;