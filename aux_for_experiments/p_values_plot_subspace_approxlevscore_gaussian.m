...
if(in.sigma_k)
    ...
    hold on;
    plot(p_values,out.subspace_approxlevscore_gaussian.sigma_k./S(k,k),'r');
    h_legend = legend('subspace_approxlevscore_gaussian');
...
if(in.froerr)
    ...
    hold on;
    plot(p_values,out.subspace_approxlevscore_gaussian.froerr./fro_A_A_k,'r');
    h_legend = legend('subspace_approxlevscore_gaussian');
    set(h_legend,'FontSize',5);
    xlabel('value of p','FontSize',15);
...
if(in.froerr_k)
    ...
    hold on;
    plot(p_values,out.subspace_approxlevscore_gaussian.froerr_k./fro_A_A_k,'r');
    h_legend = legend('subspace_approxlevscore_gaussian');
    set(h_legend,'FontSize',5);
    xlabel('value of p','FontSize',15);
...
if(in.specerr)
    ...
    hold on;
    plot(p_values,out.subspace_approxlevscore_gaussian.specerr./spec_A_A_k,'r');
    h_legend = legend('subspace_approxlevscore_gaussian');
    set(h_legend,'FontSize',5);
    xlabel('value of p','FontSize',15);
...
if(in.specerr_k)
    ...
    hold on;
    plot(p_values,out.subspace_approxlevscore_gaussian.specerr_k./spec_A_A_k,'r');
    h_legend = legend('subspace_approxlevscore_gaussian');
    set(h_legend,'FontSize',5);
