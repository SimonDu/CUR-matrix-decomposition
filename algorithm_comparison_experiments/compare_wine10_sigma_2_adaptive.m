...
save('./output/compare_wine10_sigma_2_adaptive');

c_values_plot;
saveas(gcf,'./plots/c_plots_wine_10_sigma_2_adaptive','fig');
export_fig(gcf,'./plots/c_plots_wine_10_sigma_2_adaptive.pdf');
close all;