% RBF kernel for abalone dataset with sigma = 2 and target rank = 10
in.sigma = 2;
...
save('./output/compare_abalone10_sigma_2');

c_values_plot;
saveas(gcf,'./plots/c_plots_abalone_10_sigma_2','fig');
export_fig(gcf,'./plots/c_plots_abalone_10_sigma_2.pdf');
close all;